...
public class NowPlayingMoviesAdapter extends RecyclerView.Adapter<NowPlayingMoviesAdapter.NowPlayingMoviesViewHolder> {
    ...
    public static final String LOG_TAG = NowPlayingMoviesAdapter.class.getSimpleName();
    ...
    public NowPlayingMoviesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new NowPlayingMoviesViewHolder(itemView);
    }
    ...
    public void onBindViewHolder(@NonNull NowPlayingMoviesViewHolder holder, int position) {
        if (!nowPlayingMovies.isEmpty()) {
            ...
            Movie movie = nowPlayingMovies.get(position);
    ...
    public void setData(List<Movie> nowPlayingMovies) { this.nowPlayingMovies = nowPlayingMovies; }

    class NowPlayingMoviesViewHolder extends RecyclerView.ViewHolder {

        private ImageView movieImage;
        private TextView movieTitle;
        private TextView movieDesc;

        public NowPlayingMoviesViewHolder(@NonNull View itemView) {
            super(itemView);
    ...
    public void setOnItemClickListener(ClickListener clickListener) {
        NowPlayingMoviesAdapter.clickListener = clickListener;
    }
